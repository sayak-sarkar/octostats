...
app.controller("AppCtrl", function ($http, $scope) {
	$scope.fetchData = function () {
		...
		displayCharts = function() {
		    ...
		    $http.get("https://api.github.com/users/" + $scope.formUsernameText + "/repos?per_page=9999")
				.success(function (data) {
		            ...
		            pie = r.piechart(100, 150, 75, count, {
		                legend: languages,
		                legendpos: "east"
		            });
		            pie.hover(function () {
		            ...
		            var data, value, datanode, valuenode, node;
		            for (item in languages) {
		                node = document.createElement("tr");
		                data = document.createElement("td");
		                value = document.createElement("td");
		                datanode = document.createTextNode(languages[item]);
		                data.appendChild(datanode);
		                valuenode = document.createTextNode(count[item].value);
